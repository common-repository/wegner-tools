...
= 1.0.4 =
- Fix errors when using Visual Editor, like Elementor 

= 1.0.3 =
- New function for "DIVI Image Auto-Update Alt & Title" Support WP > 6
...
= 1.0.3 =
- From WP version higher 5.9.3 a critical error is issued
